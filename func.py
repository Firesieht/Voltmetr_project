...
class func:
    ...
    def yellow_eleps(self):
        ...
        while 1:
            ...
            if cv.waitKey(1) & 0xFF == ord('q'):
                ...
                stroka = str(min_h) + " " + str(min_s) + " " + str(min_v) + " " + str(max_h) + " " + str(
                    max_s) + " " + str(
                    max_v)
    ...
    def chert(self):
        ...
        try:
            sr = list(list(f.readlines()[1].split("\n"))[0].split("QQQ"))
        except IndexError:
...
def cutting_img(frame):
    ...
    try:
        ...
        print("Квадраты не нашлись, начните настройку заново")
        return
